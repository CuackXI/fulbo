...
class StatsEquipo(models.Model):
    ...
    DiferenciaGoles=models.IntegerField(null=True)
    PartidosJugados=models.IntegerField()
    ...
    PuntosLocal=models.IntegerField(null=True)
    PuntosVisitante=models.IntegerField(null=True)
    PartidosGanadosLocal=models.IntegerField()
    PartidosPerdidosLocal=models.IntegerField()
    PartidosEmpatadosLocal=models.IntegerField()
    PartidosGanadosVisitante=models.IntegerField()
    PartidosEmpatadosVisitante=models.IntegerField()
    PartidosPerdidosVisitante=models.IntegerField()
    GolesFavorLocal=models.IntegerField()
    GolesFavorVisitante=models.IntegerField()
    SinGoles=models.IntegerField()
    SinGolesLocal=models.IntegerField()
    SinGolesVisitante=models.IntegerField()
    Penales=models.IntegerField()
    Amarillas=models.IntegerField()
    Rojas=models.IntegerField()
    GolesContraLocal=models.IntegerField()
    GolesContraVisitante=models.IntegerField()